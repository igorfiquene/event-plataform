		...
		<div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
			<div className="w-full max-w-[1110px] flex items-center justify-between mt-20 mx-auto">
				<div className="max-w-[640px]">
					...
					<p className="mt-4 text-gray-400 leading-relaxed">Em apenas uma semana você vai dominar na prática uma das tecnologias mais utilizadas e com alta demanda para acessar as melhores oportunidades do mercado.</p>
				</div>
